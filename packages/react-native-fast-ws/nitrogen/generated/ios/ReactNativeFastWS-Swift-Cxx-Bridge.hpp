...
namespace margelo::nitro::grabbou::bridge::swift {
  ...
  public:
    explicit Func_void_std__string_Wrapper(const std::function<void(const std::string& /* message */)>& func): function(func) {}
    explicit Func_void_std__string_Wrapper(std::function<void(const std::string& /* message */)>&& func): function(std::move(func)) {}
  
    void call(std::string message) const {
      function(message);
    }
  
    std::function<void(const std::string& /* message */)> function;
  };
