...
namespace margelo::nitro::fastio {
  ...
  public:
    explicit RequestOptions(std::string url, RequestMethod method, std::optional<std::shared_ptr<margelo::nitro::fastio::HybridInputStreamSpec>> body, std::unordered_map<std::string, std::string> headers): url(url), method(method), body(body), headers(headers) {}
  };
