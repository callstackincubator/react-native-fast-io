...
public final class FastIOAutolinking {
  ...
  /**
   * Creates an instance of a Swift class that implements `HybridStreamManagerSpec`,
   * and wraps it in a Swift class that can directly interop with C++ (`HybridStreamManagerSpecCxx`)
   *
   * This is generated by Nitrogen and will initialize the class specified
   * in the `"autolinking"` property of `nitro.json` (in this case, `HybridStreamManager`).
   */
  public static func createStreamManager() -> bridge.std__shared_ptr_margelo__nitro__fastio__HybridStreamManagerSpec_ {
    let hybridObject = HybridStreamManager()
    return { () -> bridge.std__shared_ptr_margelo__nitro__fastio__HybridStreamManagerSpec_ in
      let __cxxWrapped = HybridStreamManagerSpecCxx(hybridObject)
      let __pointer = HybridStreamManagerSpecCxxUnsafe.toUnsafe(__cxxWrapped)
      return bridge.create_std__shared_ptr_margelo__nitro__fastio__HybridStreamManagerSpec_(__pointer)
    }()
  }
}
