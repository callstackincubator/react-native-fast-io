...
public final class FastIOAutolinking {
  ...
  /**
   * Creates an instance of a Swift class that implements `HybridGzipCompressorSpec`,
   * and wraps it in a Swift class that can directly interop with C++ (`HybridGzipCompressorSpecCxx`)
   *
   * This is generated by Nitrogen and will initialize the class specified
   * in the `"autolinking"` property of `nitro.json` (in this case, `HybridGzipCompressor`).
   */
  public static func createGzipCompressor() -> bridge.std__shared_ptr_margelo__nitro__fastio__HybridGzipCompressorSpec_ {
    let hybridObject = HybridGzipCompressor()
    return { () -> bridge.std__shared_ptr_margelo__nitro__fastio__HybridGzipCompressorSpec_ in
      let __cxxWrapped = HybridGzipCompressorSpecCxx(hybridObject)
      let __pointer = HybridGzipCompressorSpecCxxUnsafe.toUnsafe(__cxxWrapped)
      return bridge.create_std__shared_ptr_margelo__nitro__fastio__HybridGzipCompressorSpec_(__pointer)
    }()
  }
}
