...
public class HybridFileSystemSpec_cxx {
  ...
  // Methods
  @inline(__always)
  public final func getMetadata(path: std.string) -> bridge.Result_Metadata_ {
    do {
  ...
  @inline(__always)
  public final func getWellKnownDirectoryPath(directory: Int32) -> bridge.Result_std__string_ {
    do {
  ...
  @inline(__always)
  public final func showOpenFilePicker(options: bridge.std__optional_NativeFilePickerOptions_) -> bridge.Result_std__shared_ptr_Promise_std__vector_std__string____ {
    do {
