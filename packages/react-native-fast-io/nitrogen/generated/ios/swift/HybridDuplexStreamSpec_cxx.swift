...
public class HybridDuplexStreamSpec_cxx {
   ...
   */
  private var __cxxPart: bridge.std__weak_ptr_margelo__nitro__fastio__HybridDuplexStreamSpec_
   ...
   * The C++ part is a `std::shared_ptr<margelo::nitro::fastio::HybridDuplexStreamSpec>`.
   */
  public func getCxxPart() -> bridge.std__shared_ptr_margelo__nitro__fastio__HybridDuplexStreamSpec_ {
    let cachedCxxPart = self.__cxxPart.lock()
    if cachedCxxPart.__convertToBool() {
      return cachedCxxPart
    } else {
      let newCxxPart = bridge.create_std__shared_ptr_margelo__nitro__fastio__HybridDuplexStreamSpec_(self.toUnsafe())
      __cxxPart = bridge.weakify_std__shared_ptr_margelo__nitro__fastio__HybridDuplexStreamSpec_(newCxxPart)
      return newCxxPart
    }
  }
  ...
  // Properties
  public final var inputStream: bridge.std__shared_ptr_margelo__nitro__fastio__HybridInputStreamSpec_ {
    @inline(__always)
    get {
  ...
  public final var outputStream: bridge.std__shared_ptr_margelo__nitro__fastio__HybridOutputStreamSpec_ {
    @inline(__always)
    get {
