...
namespace margelo::nitro::fastio::bridge::swift {
  ...
  Func_void_Response create_Func_void_Response(void* _Nonnull swiftClosureWrapper) {
    auto swiftClosure = FastIO::Func_void_Response::fromUnsafe(swiftClosureWrapper);
    return [swiftClosure = std::move(swiftClosure)](const Response& result) mutable -> void {
      swiftClosure.call(result);
    };
  }
