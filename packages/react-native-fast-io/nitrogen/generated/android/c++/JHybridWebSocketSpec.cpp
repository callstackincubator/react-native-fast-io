...
namespace margelo::nitro::fastio {
  ...
  void JHybridWebSocketSpec::send(const std::string& message) {
    static const auto method = javaClassStatic()->getMethod<void(jni::alias_ref<jni::JString> /* message */)>("send");
  ...
  void JHybridWebSocketSpec::sendArrayBuffer(const std::shared_ptr<ArrayBuffer>& buffer) {
    static const auto method = javaClassStatic()->getMethod<void(jni::alias_ref<JArrayBuffer::javaobject> /* buffer */)>("sendArrayBuffer");
    method(_javaPart, JArrayBuffer::wrap(buffer));
  }
  void JHybridWebSocketSpec::connect() {
    static const auto method = javaClassStatic()->getMethod<void()>("connect");
    method(_javaPart);
  }
  void JHybridWebSocketSpec::close(double code, const std::string& reason) {
    static const auto method = javaClassStatic()->getMethod<void(double /* code */, jni::alias_ref<jni::JString> /* reason */)>("close");
    method(_javaPart, code, jni::make_jstring(reason));
  }
  void JHybridWebSocketSpec::ping() {
    static const auto method = javaClassStatic()->getMethod<void()>("ping");
    method(_javaPart);
  }
  void JHybridWebSocketSpec::onOpen(const std::function<void(const std::string& /* selectedProtocol */)>& callback) {
    static const auto method = javaClassStatic()->getMethod<void(jni::alias_ref<JFunc_void_std__string::javaobject> /* callback */)>("onOpen_cxx");
  ...
  void JHybridWebSocketSpec::onClose(const std::function<void(double /* code */, const std::string& /* reason */)>& callback) {
    static const auto method = javaClassStatic()->getMethod<void(jni::alias_ref<JFunc_void_double_std__string::javaobject> /* callback */)>("onClose_cxx");
  ...
  void JHybridWebSocketSpec::onError(const std::function<void(const std::string& /* error */)>& callback) {
    static const auto method = javaClassStatic()->getMethod<void(jni::alias_ref<JFunc_void_std__string::javaobject> /* callback */)>("onError_cxx");
    method(_javaPart, JFunc_void_std__string_cxx::fromCpp(callback));
  }
  ...
  void JHybridWebSocketSpec::onArrayBuffer(const std::function<void(const std::shared_ptr<ArrayBuffer>& /* buffer */)>& callback) {
    static const auto method = javaClassStatic()->getMethod<void(jni::alias_ref<JFunc_void_std__shared_ptr_ArrayBuffer_::javaobject> /* callback */)>("onArrayBuffer_cxx");
