...
namespace margelo::nitro::fastio {
  ...
  double JHybridStreamFactorySpec::getBufferSize() {
    static const auto method = javaClassStatic()->getMethod<double()>("getBufferSize");
  ...
  std::shared_ptr<margelo::nitro::fastio::HybridInputStreamSpec> JHybridStreamFactorySpec::createInputStream(const std::string& path) {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JHybridInputStreamSpec::javaobject>(jni::alias_ref<jni::JString> /* path */)>("createInputStream");
