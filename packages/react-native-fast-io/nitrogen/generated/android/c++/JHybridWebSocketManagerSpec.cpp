...
namespace margelo::nitro::fastio {
  ...
  // Methods
  std::shared_ptr<margelo::nitro::fastio::HybridWebSocketSpec> JHybridWebSocketManagerSpec::create(const std::string& url, const std::vector<std::string>& protocols) {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JHybridWebSocketSpec::javaobject>(jni::alias_ref<jni::JString> /* url */, jni::alias_ref<jni::JArrayClass<jni::JString>> /* protocols */)>("create");
