...
namespace margelo::nitro::fastio {
  ...
  public:
    ...
    void invoke(const std::string& message) const {
      static const auto method = getClass()->getMethod<void(jni::alias_ref<jni::JString> /* message */)>("invoke");
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/fastio/Func_void_std__string_cxx;";
