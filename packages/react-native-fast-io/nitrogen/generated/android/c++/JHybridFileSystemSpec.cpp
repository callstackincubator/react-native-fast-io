...
namespace margelo::nitro::fastio {
  ...
  Metadata JHybridFileSystemSpec::getMetadata(const std::string& path) {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JMetadata>(jni::alias_ref<jni::JString> /* path */)>("getMetadata");
  ...
  std::string JHybridFileSystemSpec::getWellKnownDirectoryPath(WellKnownDirectory directory) {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<jni::JString>(jni::alias_ref<JWellKnownDirectory> /* directory */)>("getWellKnownDirectoryPath");
  ...
  std::shared_ptr<Promise<std::vector<std::string>>> JHybridFileSystemSpec::showOpenFilePicker(const std::optional<NativeFilePickerOptions>& options) {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<JNativeFilePickerOptions> /* options */)>("showOpenFilePicker");
