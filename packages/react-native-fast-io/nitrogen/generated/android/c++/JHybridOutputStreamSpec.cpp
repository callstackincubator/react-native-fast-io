...
namespace margelo::nitro::fastio {
  ...
  std::shared_ptr<Promise<void>> JHybridOutputStreamSpec::write(const std::shared_ptr<ArrayBuffer>& buffer) {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<JArrayBuffer::javaobject> /* buffer */)>("write");
  ...
  void JHybridOutputStreamSpec::open() {
    static const auto method = javaClassStatic()->getMethod<void()>("open");
    method(_javaPart);
  }
