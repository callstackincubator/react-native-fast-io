///
/// HybridCompressorFactorySpec.kt
...
/**
 * A Kotlin class representing the CompressorFactory HybridObject.
 * Implement this abstract class to create Kotlin-based instances of CompressorFactory.
 */
@DoNotStrip
@Keep
@Suppress("RedundantSuppression", "KotlinJniMissingFunction", "PropertyName", "RedundantUnitReturnType", "unused")
abstract class HybridCompressorFactorySpec: HybridObject() {
  @DoNotStrip
  ...
  @DoNotStrip
  @Keep
  abstract fun create(algorithm: CompressionAlgorithm): HybridCompressorSpec

  private external fun initHybrid(): HybridData

  companion object {
    private const val TAG = "HybridCompressorFactorySpec"
    init {
      try {
