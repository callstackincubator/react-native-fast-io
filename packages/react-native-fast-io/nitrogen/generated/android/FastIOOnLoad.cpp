...
#ifndef BUILDING_FASTIO_WITH_GENERATED_CMAKE_PROJECT
#error FastIOOnLoad.cpp is not being built with the autogenerated CMakeLists.txt project. Is a different CMakeLists.txt building this?
#endif
...
int initialize(JavaVM* vm) {
  ...
  return facebook::jni::initialize(vm, [] {
    ...
    margelo::nitro::fastio::JFunc_void_std__string_cxx::registerNatives();
    margelo::nitro::fastio::JFunc_void_double_std__string_cxx::registerNatives();
    margelo::nitro::fastio::JFunc_void_std__string_cxx::registerNatives();
    margelo::nitro::fastio::JFunc_void_std__string_cxx::registerNatives();
    margelo::nitro::fastio::JFunc_void_std__shared_ptr_ArrayBuffer__cxx::registerNatives();
